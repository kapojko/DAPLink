...
* @filename:  hk32f103xxxxa_usart.c
* @brief:     API
* @author:    AE Team
  ...
  * @{
  ...
  [..]
        (#) Enable peripheral clock using
            RCC_APB2PeriphClockCmd(RCC_APB2Periph_USARTx, ENABLE) function for
            USART1 and USART6 or using RCC_APB1PeriphClockCmd(RCC_APB1Periph_USARTx, ENABLE)
...
/** @defgroup USART_Private_Defines USART_Private_Defines
  * @{
  */
...
/** @defgroup USART_Private_Functions USART_Private_Functions
  * @{
  */
...
@verbatim
 ...
 ===============================================================================
    [..] This section provides functions allowing to:
        (+) Initialize and configure the USART.
        (+) Initialize and configure the USARTx peripheral Clock and USART Prescaler.
...
/** @defgroup USART_Group2 Interrupt functions
 *  @brief   Initialization and Configuration functions
 *
@verbatim
 ===============================================================================
...
/** @defgroup USART_Group3 USART Communication functions
 *  @brief   Multiple communication methods of USART
 *
@verbatim
 ===============================================================================
 ...
 ===============================================================================
    [..] This section provides functions allowing to:
        ...
        (+) Smart Card mode of USART.
        (+) Half Duplex communication of USART.
...
/**
  ...
  * @param  USARTx: Select the USART peripheral.
  *         This parameter can be one of the following values:
  *         USART1, USART2, UART3, UART4, UART5 .
