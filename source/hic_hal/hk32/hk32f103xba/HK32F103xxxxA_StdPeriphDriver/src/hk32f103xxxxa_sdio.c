...
* @filename:  hk32f103xxxxa_sdio.c
* @brief:     This file provides all the SDIO firmware functions. 
* @author:    AE Team  
* @version:   V1.0.0/2022-06-13
*             1.Initial version
* @log:
*******************************************************************************/
...
/** @defgroup SDIO_Private_TypesDefinitions SDIO_Private_TypesDefinitions
  * @{
  */ 
...
/** @defgroup SDIO_Private_Functions SDIO_Private_Functions
  * @{
  */
