...
* @filename:  hk32f103xxxxa_misc.c
* @brief:     This file provides MISC driver.
* @author:    AE Team
...
/** @defgroup MISC_PERIPH_Constants MISC_PERIPH_Constants
  * @{
  */
...
/** @defgroup MISC_Private_Functions MISC Private Functions
  * @{
  */
