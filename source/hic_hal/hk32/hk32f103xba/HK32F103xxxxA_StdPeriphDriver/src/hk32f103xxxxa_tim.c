...
/** @defgroup TIM TIM
 ...
 ===============================================================================
    [..] This driver provides functions to configure and program the TIM
         of all hk32f103xxxxa devices These functions are split in 9 groups:
        ...
        (#) Advanced-control timers (TIM1) specific features
         ...
         (#) TIM specific TIM Trigger ADC management includes the TIM OC source
                         triger ADC.
...
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
/** @defgroup TIM_Private_Defines TIM_Private_Defines
  * @brief TIM driver Private Defines
  * @{
  */

/*!< TIM SMCR ETR register clear Mask ((~(uint32_t)0x00FF)) */
#define SMCR_ETR_MASK               ((uint16_t)0x00FF)
/*!< TIM CCMR1 register offset 0x0018 */
#define CCMR_OFFSET                 ((uint16_t)0x0018)
/*!< TIM CCE bit of CCER register set value 0x0001 */
#define CCER_CCE_SET                ((uint16_t)0x0001)
/*!< TIM CCNE bit of CCER register set value 0x0004 */
...
/** @defgroup TIM_Private_Functions TIM_Private_Functions
  * @brief TIM driver Private Functions
  * @{
  */
...
/**
  ...
  * @param  TIMx: where x can be 1, 2, 3, 4, 5, 6, 7 and 8 to select the TIM peripheral.
  * @retval None
  */
void TIM_DeInit(TIM_TypeDef* TIMx)
{
    ...
    {
        RCC_APB2PeriphResetCmd(RCC_APB1Periph_TIM2, ENABLE);
        RCC_APB2PeriphResetCmd(RCC_APB1Periph_TIM2, DISABLE);
    }
    else if (TIMx == TIM3)
    {
        RCC_APB2PeriphResetCmd(RCC_APB1Periph_TIM3, ENABLE);
        RCC_APB2PeriphResetCmd(RCC_APB1Periph_TIM3, DISABLE);
    }
    else if (TIMx == TIM4)
    {
    ...
    {
        RCC_APB1PeriphResetCmd(RCC_APB2Periph_TIM8, ENABLE);
        RCC_APB1PeriphResetCmd(RCC_APB2Periph_TIM8, DISABLE);
    }
}
...
/**
  ...
  * @param  TIMx: where x can be 1, 2, 3, 4, 5, 6, 7 and 8 to select the TIM
  *         peripheral.
...
/**
  ...
  * @param  TIMx: where x can be 1, 2, 3, 4, 5 and 8 to select the TIM.
...
/**
  ...
  * @param  TIMx: where x can be 1 and 8 to select the TIM
...
void TIM_BDTRConfig(TIM_TypeDef* TIMx, TIM_BDTRInitTypeDef *TIM_BDTRInitStruct)
{
    ...
    /* Set the Lock level, the Break enable Bit and the Ploarity, the OSSR State, the break filter,
...
void TIM_OC1Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
    ...
    tmpccmrx = TIMx->CCMR1_Output;
    /* Reset the Output Compare Mode Bits */
    tmpccmrx &= (uint16_t)(~((uint16_t)TIM_CCMR1_Output_OC1M));
    tmpccmrx &= (uint16_t)(~((uint16_t)TIM_CCMR1_Output_CC1S));
...
void TIM_OC2Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
    ...
    tmpccmrx &= (uint16_t)(~((uint16_t)TIM_CCMR1_Output_OC2M));
    tmpccmrx &= (uint16_t)(~((uint16_t)TIM_CCMR1_Output_CC2S));
    /* Select the Output Compare Mode */
...
void TIM_OC3Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
    ...
    tmpccmrx = TIMx->CCMR2_Output;
    /* Reset the Output Compare mode and Capture/Compare selection Bits */
    tmpccmrx &= (uint16_t)(~((uint16_t)TIM_CCMR2_Output_OC3M));
    tmpccmrx &= (uint16_t)(~((uint16_t)TIM_CCMR2_Output_CC3S));
    /* Select the Output Compare Mode */
    tmpccmrx |= TIM_OCInitStruct->TIM_OCMode;
    /* Reset the Output Polarity level */
...
void TIM_OC4Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
    ...
    tmpccmrx = TIMx->CCMR2_Output;
    /* Reset the Output Compare mode and Capture/Compare selection Bits */
    tmpccmrx &= (uint16_t)(~((uint16_t)TIM_CCMR2_Output_OC4M));
    tmpccmrx &= (uint16_t)(~((uint16_t)TIM_CCMR2_Output_CC4S));
    /* Select the Output Compare Mode */
    tmpccmrx |= (uint16_t)(TIM_OCInitStruct->TIM_OCMode << 8);
    /* Reset the Output Polarity level */
...
void TIM_SelectOCxM(TIM_TypeDef* TIMx, uint16_t TIM_Channel, uint16_t TIM_OCMode)
{
    ...
    if ((TIM_Channel == TIM_Channel_1) || (TIM_Channel == TIM_Channel_3))
    {
        ...
        *(__IO uint32_t *) tmp &= (uint32_t)~((uint32_t)TIM_CCMR1_Output_OC1M);
    ...
    else
    {
        ...
        /* Reset the OCxM bits in the CCMRx register */
        *(__IO uint32_t *) tmp &= (uint32_t)~((uint32_t)TIM_CCMR1_Output_OC2M);
        /* Configure the OCxM bits in the CCMRx register */
...
void TIM_ForcedOC1Config(TIM_TypeDef* TIMx, uint16_t TIM_ForcedAction)
{
    ...
    tmpccmr1 = TIMx->CCMR1_Output;
    /* Reset the OC1M Bits */
    tmpccmr1 &= (uint16_t)~((uint16_t)TIM_CCMR1_Output_OC1M);
    /* Configure The Forced output Mode */
    tmpccmr1 |= TIM_ForcedAction;
    /* Write to TIMx CCMR1 register */
    TIMx->CCMR1_Output = tmpccmr1;
}
...
void TIM_ForcedOC2Config(TIM_TypeDef* TIMx, uint16_t TIM_ForcedAction)
{
    ...
    tmpccmr1 = TIMx->CCMR1_Output;
    /* Reset the OC2M Bits */
    tmpccmr1 &= (uint16_t)~((uint16_t)TIM_CCMR1_Output_OC2M);
    /* Configure The Forced output Mode */
...
void TIM_ForcedOC3Config(TIM_TypeDef* TIMx, uint16_t TIM_ForcedAction)
{
    ...
    assert_param(IS_TIM_LIST2_PERIPH(TIMx));
    assert_param(IS_TIM_FORCED_ACTION(TIM_ForcedAction));
    tmpccmr2 = TIMx->CCMR2_Output;
    /* Reset the OC3M Bits */
    tmpccmr2 &= (uint16_t)~((uint16_t)TIM_CCMR2_Output_OC3M);
    /* Configure The Forced output Mode */
    tmpccmr2 |= TIM_ForcedAction;
    /* Write to TIMx CCMR2 register */
    TIMx->CCMR2_Output = tmpccmr2;
}
...
void TIM_ForcedOC4Config(TIM_TypeDef* TIMx, uint16_t TIM_ForcedAction)
{
    ...
    tmpccmr2 = TIMx->CCMR2_Output;
    /* Reset the OC4M Bits */
    tmpccmr2 &= (uint16_t)~((uint16_t)TIM_CCMR2_Output_OC4M);
    /* Configure The Forced output Mode */
...
void TIM_OC1PreloadConfig(TIM_TypeDef* TIMx, uint16_t TIM_OCPreload)
{
    ...
    tmpccmr1 = TIMx->CCMR1_Output;
    /* Reset the OC1PE Bit */
    tmpccmr1 &= (uint16_t)~((uint16_t)TIM_CCMR1_Output_OC1PE);
...
void TIM_OC2PreloadConfig(TIM_TypeDef* TIMx, uint16_t TIM_OCPreload)
{
    ...
    tmpccmr1 = TIMx->CCMR1_Output;
    /* Reset the OC2PE Bit */
    tmpccmr1 &= (uint16_t)~((uint16_t)TIM_CCMR1_Output_OC2PE);
    /* Enable or Disable the Output Compare Preload feature */
...
void TIM_OC3PreloadConfig(TIM_TypeDef* TIMx, uint16_t TIM_OCPreload)
{
    ...
    tmpccmr2 = TIMx->CCMR2_Output;
    /* Reset the OC3PE Bit */
    tmpccmr2 &= (uint16_t)~((uint16_t)TIM_CCMR2_Output_OC3PE);
    /* Enable or Disable the Output Compare Preload feature */
...
void TIM_OC4PreloadConfig(TIM_TypeDef* TIMx, uint16_t TIM_OCPreload)
{
    ...
    tmpccmr2 = TIMx->CCMR2_Output;
    /* Reset the OC4PE Bit */
    tmpccmr2 &= (uint16_t)~((uint16_t)TIM_CCMR2_Output_OC4PE);
    /* Enable or Disable the Output Compare Preload feature */
...
void TIM_OC1FastConfig(TIM_TypeDef* TIMx, uint16_t TIM_OCFast)
{
    ...
    tmpccmr1 = TIMx->CCMR1_Output;
    /* Reset the OC1FE Bit */
    tmpccmr1 &= (uint16_t)~((uint16_t)TIM_CCMR1_Output_OC1FE);
...
void TIM_OC2FastConfig(TIM_TypeDef* TIMx, uint16_t TIM_OCFast)
{
    ...
    tmpccmr1 = TIMx->CCMR1_Output;
    /* Reset the OC2FE Bit */
    tmpccmr1 &= (uint16_t)~((uint16_t)TIM_CCMR1_Output_OC2FE);
    /* Enable or Disable the Output Compare Fast Bit */
...
void TIM_OC3FastConfig(TIM_TypeDef* TIMx, uint16_t TIM_OCFast)
{
    ...
    tmpccmr2 = TIMx->CCMR2_Output;
    /* Reset the OC3FE Bit */
    tmpccmr2 &= (uint16_t)~((uint16_t)TIM_CCMR2_Output_OC3FE);
    /* Enable or Disable the Output Compare Fast Bit */
    tmpccmr2 |= TIM_OCFast;
    /* Write to TIMx CCMR2 */
    TIMx->CCMR2_Output = tmpccmr2;
...
void TIM_OC4FastConfig(TIM_TypeDef* TIMx, uint16_t TIM_OCFast)
{
    ...
    tmpccmr2 = TIMx->CCMR2_Output;
    /* Reset the OC4FE Bit */
    tmpccmr2 &= (uint16_t)~((uint16_t)TIM_CCMR2_Output_OC4FE);
    /* Enable or Disable the Output Compare Fast Bit */
...
void TIM_ClearOC1Ref(TIM_TypeDef* TIMx, uint16_t TIM_OCClear)
{
    ...
    tmpccmr1 = TIMx->CCMR1_Output;
    /* Reset the OC1CE Bit */
    tmpccmr1 &= (uint16_t)~((uint16_t)TIM_CCMR1_Output_OC1CE);
...
void TIM_ClearOC2Ref(TIM_TypeDef* TIMx, uint16_t TIM_OCClear)
{
    ...
    tmpccmr1 = TIMx->CCMR1_Output;
    /* Reset the OC2CE Bit */
    tmpccmr1 &= (uint16_t)~((uint16_t)TIM_CCMR1_Output_OC2CE);
    /* Enable or Disable the Output Compare Clear Bit */
...
void TIM_ClearOC3Ref(TIM_TypeDef* TIMx, uint16_t TIM_OCClear)
{
    ...
    tmpccmr2 = TIMx->CCMR2_Output;
    /* Reset the OC3CE Bit */
    tmpccmr2 &= (uint16_t)~((uint16_t)TIM_CCMR2_Output_OC3CE);
    /* Enable or Disable the Output Compare Clear Bit */
...
void TIM_ClearOC4Ref(TIM_TypeDef* TIMx, uint16_t TIM_OCClear)
{
    ...
    tmpccmr2 = TIMx->CCMR2_Output;
    /* Reset the OC4CE Bit */
    tmpccmr2 &= (uint16_t)~((uint16_t)TIM_CCMR2_Output_OC4CE);
    /* Enable or Disable the Output Compare Clear Bit */
...
/**
  ...
  * @param  TIMx: TIMx: where x can be 1 and 8 to select the TIM.
                       ...
                       uint16_t TIM_ICFilter)
{
    ...
    /* Disable the Channel 1: Reset the CC1E Bit */
    TIMx->CCER &= (uint32_t)~((uint32_t)TIM_CCER_CC1E);
    tmpccmr1 = TIMx->CCMR1_Input;
    tmpccer = TIMx->CCER;
    /* Select the Input and set the filter */
    tmpccmr1 &= (uint16_t)(((uint16_t)~((uint16_t)TIM_CCMR1_Input_CC1S)) & ((uint16_t)~((uint16_t)TIM_CCMR1_Input_IC1F)));
    ...
    TIMx->CCMR1_Input = tmpccmr1;
    TIMx->CCER = tmpccer;
}

/**
  * @brief  Configure the TI2 as Input.
  * @param  TIMx: where x can be 1, 2, 3, 4, 5 and 8 to select the TIMTIMx: where x can be 1, 2, 3, 4, 5 and 8 to select the TIM.
  * @param  TIM_ICPolarity: The Input Polarity.
  *         This parameter can be one of the following values:
  *            @arg TIM_ICPolarity_Rising
  *            @arg TIM_ICPolarity_Falling
                       ...
                       uint16_t TIM_ICFilter)
{
    ...
    /* Select the Input and set the filter */
    tmpccmr1 &= (uint16_t)(((uint16_t)~((uint16_t)TIM_CCMR1_Input_CC2S)) & ((uint16_t)~((uint16_t)TIM_CCMR1_Input_IC2F)));
...
static void TI3_Config(TIM_TypeDef* TIMx, uint16_t TIM_ICPolarity, uint16_t TIM_ICSelection,
                       uint16_t TIM_ICFilter)
{
    uint16_t tmpccmr2 = 0, tmp = 0;
    uint32_t tmpccer = 0;
    /* Disable the Channel 3: Reset the CC3E Bit */
    TIMx->CCER &= (uint32_t)~((uint32_t)TIM_CCER_CC3E);
    tmpccmr2 = TIMx->CCMR2_Input;
    tmpccer = TIMx->CCER;
    tmp = (uint16_t)(TIM_ICPolarity << 8);
    /* Select the Input and set the filter */
    tmpccmr2 &= (uint16_t)(((uint16_t)~((uint16_t)TIM_CCMR2_Input_CC3S)) & ((uint16_t)~((uint16_t)TIM_CCMR2_Input_IC3F)));
                       ...
                       uint16_t TIM_ICFilter)
{
    ...
    /* Select the Input and set the filter */
    tmpccmr2 &= (uint16_t)((uint16_t)(~(uint16_t)TIM_CCMR2_Input_CC4S) & ((uint16_t)~((uint16_t)TIM_CCMR2_Input_IC4F)));
...
void TIM_SetIC1Prescaler(TIM_TypeDef* TIMx, uint16_t TIM_ICPSC)
{
    ...
    TIMx->CCMR1_Input &= (uint16_t)~((uint16_t)TIM_CCMR1_Input_IC1PSC);
    /* Set the IC1PSC value */
    TIMx->CCMR1_Input |= TIM_ICPSC;
}
...
void TIM_SetIC2Prescaler(TIM_TypeDef* TIMx, uint16_t TIM_ICPSC)
{
    ...
    TIMx->CCMR1_Input &= (uint16_t)~((uint16_t)TIM_CCMR1_Input_IC2PSC);
    /* Set the IC2PSC value */
    TIMx->CCMR1_Input |= (uint16_t)(TIM_ICPSC << 8);
}
...
void TIM_SetIC3Prescaler(TIM_TypeDef* TIMx, uint16_t TIM_ICPSC)
{
    ...
    TIMx->CCMR2_Input &= (uint16_t)~((uint16_t)TIM_CCMR2_Input_IC3PSC);
    /* Set the IC3PSC value */
    TIMx->CCMR2_Input |= TIM_ICPSC;
}
...
void TIM_SetIC4Prescaler(TIM_TypeDef* TIMx, uint16_t TIM_ICPSC)
{
    ...
    TIMx->CCMR2_Input &= (uint16_t)~((uint16_t)TIM_CCMR2_Input_IC4PSC);
    /* Set the IC4PSC value */
    TIMx->CCMR2_Input |= (uint16_t)(TIM_ICPSC << 8);
}
...
/**
  ...
  * @note   TIM2,TIM3,TIM4, and TIM5 do not have TIM_IT_COM or TIM_IT_Break functions.
  * @note   TIM6 and TIM7 only have the TIM_IT_Update function.
...
/**
  ...
  * @note   TIM_EventSource_COM and TIM_EventSource_Break are used only with TIM1 or TIM8.
  * @note   TIM6 and TIM7 only have the TIM_EventSource_Update function.
  * @retval None
  */
...
/**
  ...
  * @note   TIM6 and TIM7 only have the TIM_FLAG_Update function.
  * @note   TIM_FLAG_Break is used only with TIM1 and TIM8.
  * @note   TIM_FLAG_COM is used only with TIM1 TIM1 and TIM8.
...
/**
  ...
  * @param  TIMx: where x can be 1, 2, 3, 4, 5 and 8 to select the TIM peripheral.
...
/**
  ...
  *            @arg TIM_ICPolarity_BothEdge: IC Both edge.
                                ...
                                uint16_t TIM_IC1Polarity, uint16_t TIM_IC2Polarity)
{
    ...
    tmpccmr1 &= (uint16_t)(((uint16_t)~((uint16_t)TIM_CCMR1_Input_CC1S)) & (uint16_t)(~((uint16_t)TIM_CCMR1_Output_CC2S)));
    tmpccmr1 |= TIM_CCMR1_Output_CC1S_0 | TIM_CCMR1_Output_CC2S_0;
