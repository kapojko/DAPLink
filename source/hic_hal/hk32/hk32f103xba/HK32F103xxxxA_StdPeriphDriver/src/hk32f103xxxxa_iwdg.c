  ...
  * @{
  ...
  ==============================================================================
    ...
    [..] Min-max timeout value 40KHz (LSI): ~0.1ms / ~28.3s
         The IWDG timeout may vary due to LSI frequency dispersion. hk32f103xxxxa
         ...
         For more information, please refer to the hk32f103xxxxa Reference manual.
...
/** @defgroup IWDG_Private_Defines IWDG_Private_Defines
  * @{
  */
