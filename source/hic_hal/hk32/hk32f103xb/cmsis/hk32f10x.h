/**
  ...
  *          definitions and memory mapping for HK32F10x Connectivity line, 
...
#if !defined (HK32F103C8XX) && !defined (HK32F103CBXX) && !defined (HK32F103R8XX) && !defined (HK32F103RBXX) \
	&& !defined (HK32F103V8XX) && !defined (HK32F103VBXX) && !defined (HK32F103C8T6A) && !defined (HK32F103CBT6A) \
  && !defined (HK32F103R8T6A) && !defined (HK32F103RBT6A) && !defined (HK32F103V8T6A) && !defined (HK32F103VBT6A) \
  && !defined (HK32F103RCXX) && !defined (HK32F103RDXX) && !defined (HK32F103REXX) && !defined (HK32F103VCXX) \
   && !defined (HK32F103VDXX) && !defined (HK32F103VEXX) && !defined (HK32F103CBT6)
 #error "Please select first the target HK32F10x device used in your application (in HK32f10x.h file)"
#endif

#if defined (HK32F103C8XX) || defined (HK32F103CBXX) || defined (HK32F103R8XX) || defined (HK32F103RBXX)||defined (HK32F103V8XX) || defined (HK32F103VBXX) || defined (HK32F103CBT6)
#define HK32F10X_MD
#endif 

#if defined (HK32F103C8T6A) || defined (HK32F103CBT6A) || defined (HK32F103R8T6A) || defined (HK32F103RBT6A)||defined (HK32F103V8T6A) || defined (HK32F103VBT6A) 
#define HK32F10X_MDA
#endif

#if defined (HK32F103RCXX) || defined (HK32F103RDXX) || defined (HK32F103REXX) || defined (HK32F103VCXX) || defined (HK32F103VDXX) || defined (HK32F103VEXX)
#define HK32F10X_HD
#endif
/**
...
/**
 * @brief HK32F10x Interrupt Number Definition, according to the selected device 
...
/******  HK32 specific Interrupt Numbers *********************************************************/
  ...
  DIVSQRT_IRQn                = 47      /*!< DIVSQRT Event Interrupt                              */ 
#endif /* HK32F10X_MD */  
...
/*!< HK32F10x Standard Peripheral Library old types (maintained for legacy purpose) */
typedef int32_t  s32;
typedef int16_t s16;
typedef int8_t  s8;
...
/*!< HK32F10x Standard Peripheral Library old definitions (maintained for legacy purpose) */
...
#ifdef HK32F10X_MD
#define DIVSQRT_BASE          (APB1PERIPH_BASE + 0x00030000) 
#else   // HK32F10X_MDA||HK32F10X_HD
#define COALU_BASE            (APB1PERIPH_BASE + 0x00030000) /*!< COALU registers base address */
#endif
...
typedef struct {                                /*!< (@ 0x40030000) DIVSQRT Structure                                          */
  ...
  __IOM uint32_t  CSR;                          /*!< (@ 0x00000008) control and status Register                                */
  __IOM uint32_t  RADICAND;                     /*!< (@ 0x0000000C) RADICANDED Register                                        */
  __IOM uint32_t  RES;                          /*!< (@ 0x00000010) Result register                                            */
  __IOM uint32_t  REMAINDER;                    /*!< (@ 0x00000014) remainder register                                         */
} DIVSQRT_Type;   
#else
