/**
  ...
  *                      the "startup_hk32f10x_xx.s" file.
  *
  ...
  *    Then SystemInit() function is called, in "startup_hk32f10x_xx.s" file, to
  ...
  *    the product used), refer to "HSE_VALUE" define in "hk32f10x.h" file. 
...
/** @addtogroup HK32F10x_System_Private_Variables
  * @{
  */
...
/** @addtogroup HK32F10x_System_Private_FunctionPrototypes
  * @{
  */
...
/** @addtogroup HK32F10x_System_Private_Functions
  * @{
  */
...
/**
  ...
  *         
  *         (*) HSI_VALUE is a constant defined in hk32f1xx.h file (default value
  *             8 MHz) but the real value may vary depending on the variations
  *             in voltage and temperature.   
  *    
  *         (**) HSE_VALUE is a constant defined in hk32f1xx.h file (default value
...
/**
  * @brief  Setup the external memory controller. Called in startup_hk32f10x.s 
...
/**
  ...
  *         Called in startup_hk32f10x_xx.s/.c before jump to main. 	      
  * @param  None
  * @retval None
  */ 
...
static void SetSysClockTo72(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    // NOTE: no need to set USB prescaler (divider) since it is 1.5 by default
...
static void SetSysClockToHSI48(void)
{
  ...
  if (HSIStatus == (uint32_t)0x01)
  {
    ...
    // NOTE: 在RCC_APB1ENR寄存器中使能USB时钟之前，必须保证该位已经有效。如果USB时钟被使能，该位不能被清零。
...
static void SetSysClockToHSI72(void)
{
  ...
  if (HSIStatus == (uint32_t)0x01)
  {
    ...
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(((uint32_t)1 << 31) | RCC_CFGR_PLLMULL9);
