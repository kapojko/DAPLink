...
#include "string.h"
#include "stm32h7xx.h"
// The H7 HAL defines UART_PARITY_NONE/EVEN/ODD as numeric macros, which
// collide with the DAPLink uart.h enum of the same names. Undefine the
// HAL versions here (before uart.h) so the enum can be declared.
...
// CDC UART (USART3 on PB10/PB11 - matches CubeMX demo)
...
#define UART_ALTFUNC                GPIO_AF7_USART3  // PB10/PB11 = AF7
