...
if ($if) {
    ...
    Invoke-OpenOCD "projectfiles/cmake_gcc_arm/hk32f103xb_if/build/hk32f103xb_if.hex"
    Write-Host "Done."
    exit
}
...
if ($bl) {
    ...
    Invoke-OpenOCD "projectfiles/cmake_gcc_arm/hk32f103xb_bl/build/hk32f103xb_bl.hex"
    Write-Host "Done."
    exit
}
