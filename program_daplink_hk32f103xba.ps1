...
if ($if) {
    ...
    Invoke-OpenOCD "projectfiles/cmake_gcc_arm/hk32f103xba_if/build/hk32f103xba_if.hex"
    Write-Host "Done."
    exit
}
...
if ($bl) {
    ...
    Invoke-OpenOCD "projectfiles/cmake_gcc_arm/hk32f103xba_bl/build/hk32f103xba_bl.hex"
    Write-Host "Done."
    exit
}
